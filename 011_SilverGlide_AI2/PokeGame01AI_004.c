...
100        }
110    }
120    clrscr(); /* clscr から clrscr へ修正 */
125 RESTART:
...
430        }
440        
450        /* 柱の描画（t=0:上空から、t=1:地面から） */
460        if(t == 0) {
470            line(o, 8, o, 8+h, 0, 0xFFFF, 0);
480        } else {
490            line(o, 47-(h-4), o, 47, 0, 0xFFFF, 0);
500        }
510        
520        /* 当たり判定 (BASIC版準拠) */
530        if(o >= x && o <= x+7) {
540            if(t == 0 && y < 8+h) break;
550            if(t == 1 && y > 47-(h-4)-7) break;
560        }
570    }
580    clrscr(); /* clscr から clrscr へ修正 */
590    printf("GAME OVER\n");
600    printf("SCORE:%d\n", s);
610    printf("PRESS 1 TO RESTART\n");
620    while(1) { if(kbhit() && getch() == '1') break; }
630    goto RESTART;
640 }